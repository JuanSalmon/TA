...
<head>
  ...
  <!-- Favicon icon-->
  <link rel="shortcut icon" type="image/png" href="../../../src/assets/images/logos/lo.png" />
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav align-items-center mb-2 mb-lg-0 ms-auto">
              <li class="nav-item ms-2">
                <a class="btn btn-primary fs-3 rounded btn-hover-shadow px-3 py-2" href="../../login/index.html">Login</a>
              </li>
              <li class="nav-item ms-2">
                <a class="btn btn-outline-primary fs-3 rounded btn-hover-shadow px-3 py-2" href="../../regis/index.html">Register</a>
              </li>
            </ul>
          </div>
        </div>
            ...
            <div class="col-xl-6">
              <div class="hero-content my-5 my-xl-0">
                ...
                <p class="fs-5 mb-5 text-dark fw-normal" data-aos="fade-up" data-aos-delay="600" data-aos-duration="1000">
                 1. Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sit ad laudantium quasi, autem quia corrupti dolorum neque quidem natus nobis et delectus? Quisquam nam animi magni nobis. Quisquam, eius adipisci.
                </p>
                <div class="d-sm-flex align-items-center gap-3" data-aos="fade-up" data-aos-delay="800" data-aos-duration="1000">
                  <a class="btn btn-primary px-5 py-6 btn-hover-shadow d-block mb-3 mb-sm-0" href="../../login/index.html">Login</a>
                  <h5>or</h5>
                  <a class="btn btn-outline-primary d-block scroll-link px-7 py-6" href="../../regis/index.html">Register</a>
                </div>
              </div>
            </div>
            <!-- scroll image  -->
            ...
            <div class="col-lg-8" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
              <div class="d-sm-flex align-items-center text-center gap-2 justify-content-center mb-7">
                <p class="mb-0 fw-semibold fs-4 text-dark">
                  2.Lorem ipsum dolor sit, amet consectetur adipisicing elit. Veritatis nulla ea inventore a sequi provident. Sed illo sapiente velit id quae repellendus, necessitatibus praesentium distinctio est earum, iste adipisci numquam.
                </p>
              </div>
              <h2 class="text-center mb-0 fs-9 fw-bolder">
                3. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus ea voluptatum cum voluptas labore non quod sapiente? Delectus, error. Ullam, maiores! Temporibus odit reprehenderit ut nulla, sint ipsam blanditiis ea.
              </h2>
            </div>
          </div>
            ...
            <div class="demos-view mt-4">
              ...
              <div class="row justify-content-center">
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="../assets/images/frontend-pages/page-homepage.jpg" alt="modernize-img" class="img-fluid" />
                    <a target="_blank" href="../main/frontend-landingpage.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                  <h6 class="mb-0 text-center fs-3">Homepage</h6>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="../assets/images/frontend-pages/page-about.jpg" alt="modernize-img" class="img-fluid" />
                    <a target="_blank" href="../main/frontend-aboutpage.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                  <h6 class="mb-0 text-center fs-3">About us</h6>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="../assets/images/frontend-pages/page-portfolio.jpg" alt="modernize-img" class="img-fluid" />
                    <a target="_blank" href="../main/frontend-portfoliopage.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                  <h6 class="mb-0 text-center fs-3">Portfolio</h6>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 mb-7">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="../assets/images/frontend-pages/page-pricing.jpg" alt="modernize-img" class="img-fluid" />
                    <a target="_blank" href="../main/frontend-pricingpage.html" class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                      Preview</a>
                  </div>
                  <h6 class="mb-0 text-center fs-3">Pricing</h6>
                </div>
              </div>
            </div>
            <div class="demos-view mt-4">
          ...
          <div class="row justify-content-between">
            <div class="col-lg-7 col-xl-5 pt-lg-5 mb-5 mb-lg-0">
              <h2 class="fs-9 text-white text-center text-lg-start fw-bolder mb-7">
                Hubungkan perangkat embeded anda dengan broker PNK
              </h2>
              <div class="d-sm-flex align-items-center justify-content-center justify-content-lg-start gap-3">
                <a href="../../login/index.html" class="btn bg-white text-primary fw-semibold d-block mb-3 mb-sm-0 btn-hover-shadow px-7 py-6">Login</a>
                <a href="../../regis/index.html" class="btn border-white text-white fw-semibold btn-hover-white d-block px-7 py-6">Register</a>
              </div>
            </div>
    ...
    <div class="offcanvas offcanvas-start modernize-lp-offcanvas" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body p-4">
        ...
        <form class="d-flex mt-3" role="search">
          <a href="../../login/index.html" class="btn btn-primary w-100 py-2">Login</a>
        </form>
      </div>
    </div>
  </div>
