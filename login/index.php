...
<head>
  ...
  <!-- Favicon icon-->
  <link rel="shortcut icon" type="image/png" href="/login/assets/images/logos/logo-pnk.png" />
...
<body>
  <!-- Preloader -->
  <div class="preloader">
    <img src="/login/assets/images/logos/logo-pnk.png" alt="loader" class="lds-ripple img-fluid" />
  </div>
      ...
      <div class="d-flex align-items-center justify-content-center w-100">
        <div class="row justify-content-center w-100">
          <div class="col-md-8 col-lg-6 col-xxl-3 auth-card">
            <div class="card mb-0">
              <div class="card-body">
                <a href="../../../landing/landingpage/index.html" class="text-nowrap logo-img text-center d-block mb-1 w-100">
  ...
  <script src="/login/assets/libs/simplebar/dist/simplebar.min.js"></script>
  <script src="/login/assets/js/theme/app.init.js"></script>
  <script src="/login/assets/js/theme/theme.js"></script>
  <script src="/login/assets/js/theme/app.min.js"></script>
